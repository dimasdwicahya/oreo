...
<div class="container">
    ...
    <div class="form-group">
         <form name="add_name" id="add_name" action="POST">
          <input type="hidden" name="notiket" placeholder="Enter your Name" class="form-control name_list" required="" value="P0001" />
